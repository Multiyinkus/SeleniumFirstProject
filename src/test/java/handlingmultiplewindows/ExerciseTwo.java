...
public class ExerciseTwo {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement createPlugButton = driver.findElement(By.xpath("//*[@id=\"maincontent\"]/section[1]/header/a"));
		createPlugButton.click();
	...
	/*	switchToWindow("Blogger.com - Create a unique and beautiful blog easily.",driver);
		...
		driver.findElement(By.name("identifier")).sendKeys("yinkusluvsu@yahoo.com"); */
