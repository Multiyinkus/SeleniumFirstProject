...
public class PrintingEntireTableDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 * BELOW CODE WILL PRINT IN A LIST FORM INSTEAD OF TABLE FORM List<WebElement>
		 * tabledh = driver.findElements(By.xpath("//table[@id='table1']//tr/*"));
		 * 
